...
import com.covid.service.AdminServiceImpl;
...
//		          List<VaccinationCenter> lis = VaccinationCe
	...
	public ResponseEntity<VaccinationCenter> addVaccineCenter(@PathVariable("id") Integer id,@RequestParam String key) throws VaccineCenterNotFoundException {
	...
	public ResponseEntity<String> deleteVaccineCenter(@RequestBody VaccinationCenter center,@RequestParam String key) throws VaccineCenterNotFoundException {
